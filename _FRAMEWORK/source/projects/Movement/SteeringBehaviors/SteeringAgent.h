...
public:
	...
	void SetPreviousPos(const Elite::Vector2& newPos) { m_PreviousPos = newPos; }

	float GetNeighborhoodRadius() const { return m_NeighborhoodRadius; }
	void SetNeighborhoodRadius(const float newRadius) { m_NeighborhoodRadius = newRadius; }
...
protected:
	...
	Elite::Vector2 m_PreviousPos = { 0,0 };

	float m_NeighborhoodRadius{ 0 };
};
#endif